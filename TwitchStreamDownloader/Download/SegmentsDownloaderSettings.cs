...
public class SegmentsDownloaderSettings
{
    ...
    /// <summary>
    /// Это кал едва рабочий. Лучше самому искать нужное качество.
    /// Если нулл, будет брать качество с самым высоким разрешением.
    /// Если не нулл, и <see cref="TakeOnlyPreferredQuality"/> не тру, будет также брать самое высокое.
    /// </summary>
